  ...
  return (
    <>
      ...
      <main className="flex-grow">
        ...
        <section id="certifications" className="py-16 md:py-20 scroll-mt-20">
          <div className="container mx-auto px-4 md:px-6">
            <h2 className="font-headline text-3xl md:text-4xl font-bold mb-10 md:mb-14 text-center text-primary">Licenses & Certifications</h2>
